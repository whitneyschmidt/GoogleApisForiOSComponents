...
Artifact FIREBASE_AB_TESTING_ARTIFACT              = new Artifact ("Firebase.ABTesting",              "3.2.0",        "8.0", ComponentGroup.Firebase, csprojName: "ABTesting", ignore: true);
Artifact FIREBASE_AD_MOB_ARTIFACT                  = new Artifact ("Firebase.AdMob",                  "7.64.0",       "8.0", ComponentGroup.Firebase, csprojName: "AdMob");
Artifact FIREBASE_ANALYTICS_ARTIFACT               = new Artifact ("Firebase.Analytics",              "6.4.1",        "8.0", ComponentGroup.Firebase, csprojName: "Analytics", ignore: true);
Artifact FIREBASE_AUTH_ARTIFACT                    = new Artifact ("Firebase.Auth",                   "6.5.1",        "8.0", ComponentGroup.Firebase, csprojName: "Auth", ignore: true);
Artifact FIREBASE_CLOUD_FIRESTORE_ARTIFACT         = new Artifact ("Firebase.CloudFirestore",         "1.12.0",       "8.0", ComponentGroup.Firebase, csprojName: "CloudFirestore", ignore: true);
Artifact FIREBASE_CLOUD_FUNCTIONS_ARTIFACT         = new Artifact ("Firebase.CloudFunctions",         "2.5.1",        "8.0", ComponentGroup.Firebase, csprojName: "CloudFunctions", ignore: true);
Artifact FIREBASE_CLOUD_MESSAGING_ARTIFACT         = new Artifact ("Firebase.CloudMessaging",         "4.3.0",        "8.0", ComponentGroup.Firebase, csprojName: "CloudMessaging", ignore: true);
Artifact FIREBASE_CORE_ARTIFACT                    = new Artifact ("Firebase.Core",                   "6.10.1",       "8.0", ComponentGroup.Firebase, csprojName: "Core");
Artifact FIREBASE_CRASHLYTICS_ARTIFACT             = new Artifact ("Firebase.Crashlytics",            "4.5.0",        "8.0", ComponentGroup.Firebase, csprojName: "Crashlytics");
Artifact FIREBASE_DATABASE_ARTIFACT                = new Artifact ("Firebase.Database",               "6.1.4",        "8.0", ComponentGroup.Firebase, csprojName: "Database", ignore: true);
Artifact FIREBASE_DYNAMIC_LINKS_ARTIFACT           = new Artifact ("Firebase.DynamicLinks",           "4.0.8",        "8.0", ComponentGroup.Firebase, csprojName: "DynamicLinks", ignore: true);
Artifact FIREBASE_IN_APP_MESSAGING_ARTIFACT        = new Artifact ("Firebase.InAppMessaging",         "0.19.2.1",     "9.0", ComponentGroup.Firebase, csprojName: "InAppMessaging", ignore: true);
...
Artifact FIREBASE_INSTANCE_ID_ARTIFACT             = new Artifact ("Firebase.InstanceID",             "4.3.3",        "8.0", ComponentGroup.Firebase, csprojName: "InstanceID", ignore: true);
Artifact FIREBASE_MLKIT_ARTIFACT                   = new Artifact ("Firebase.MLKit",                  "0.19.0",       "9.0", ComponentGroup.Firebase, csprojName: "MLKit", ignore: true);
Artifact FIREBASE_MLKIT_COMMON_ARTIFACT            = new Artifact ("Firebase.MLKit.Common",           "0.19.0",       "9.0", ComponentGroup.Firebase, csprojName: "MLKit.Common", ignore: true);
Artifact FIREBASE_MLKIT_MODEL_INTERPRETER_ARTIFACT = new Artifact ("Firebase.MLKit.ModelInterpreter", "0.19.0",       "9.0", ComponentGroup.Firebase, csprojName: "MLKit.ModelInterpreter", ignore: true);
Artifact FIREBASE_MLKIT_NATURAL_LANGUAGE_ARTIFACT  = new Artifact ("Firebase.MLKit.NaturalLanguage",  "0.17.0",       "9.0", ComponentGroup.Firebase, csprojName: "MLKit.NaturalLanguage", ignore: true);
Artifact FIREBASE_MLKIT_VISION_ARTIFACT            = new Artifact ("Firebase.MLKit.Vision",           "0.19.0",       "9.0", ComponentGroup.Firebase, csprojName: "MLKit.Vision", ignore: true);
Artifact FIREBASE_PERFORMANCE_MONITORING_ARTIFACT  = new Artifact ("Firebase.PerformanceMonitoring",  "3.1.11",       "8.0", ComponentGroup.Firebase, csprojName: "PerformanceMonitoring", ignore: true);
Artifact FIREBASE_REMOTE_CONFIG_ARTIFACT           = new Artifact ("Firebase.RemoteConfig",           "4.4.9",        "8.0", ComponentGroup.Firebase, csprojName: "RemoteConfig", ignore: true);
Artifact FIREBASE_STORAGE_ARTIFACT                 = new Artifact ("Firebase.Storage",                "3.6.0",        "8.0", ComponentGroup.Firebase, csprojName: "Storage", ignore: true);

// Google artifacts available to be built. These artifacts generate NuGets.
Artifact GOOGLE_ANALYTICS_ARTIFACT    = new Artifact ("Google.Analytics",   "3.17.0.6", "5.0", ComponentGroup.Google, csprojName: "Analytics", ignore: true);
Artifact GOOGLE_APP_INDEXING_ARTIFACT = new Artifact ("Google.AppIndexing", "2.0.3.8",  "7.0", ComponentGroup.Google, csprojName: "AppIndexing", ignore: true);
Artifact GOOGLE_CAST_ARTIFACT         = new Artifact ("Google.Cast",        "4.4.6.1",  "9.0", ComponentGroup.Google, csprojName: "Cast", ignore: true);
Artifact GOOGLE_CORE_ARTIFACT         = new Artifact ("Google.Core",        "3.1.0.4",  "7.0", ComponentGroup.Google, csprojName: "Core", ignore: true);
Artifact GOOGLE_INSTANCE_ID_ARTIFACT  = new Artifact ("Google.InstanceID",  "1.2.1.18", "7.0", ComponentGroup.Google, csprojName: "InstanceID", ignore: true);
Artifact GOOGLE_MAPS_ARTIFACT         = new Artifact ("Google.Maps",        "3.7.0.1",  "9.0", ComponentGroup.Google, csprojName: "Maps", ignore: true);
Artifact GOOGLE_MOBILE_ADS_ARTIFACT   = new Artifact ("Google.MobileAds",   "7.64.0",   "8.0", ComponentGroup.Google, csprojName: "MobileAds");
Artifact GOOGLE_PLACES_ARTIFACT       = new Artifact ("Google.Places",      "3.7.0.1",  "9.0", ComponentGroup.Google, csprojName: "Places", ignore: true);
Artifact GOOGLE_SIGN_IN_ARTIFACT      = new Artifact ("Google.SignIn",      "5.0.2.1",  "8.0", ComponentGroup.Google, csprojName: "SignIn", ignore: true);
Artifact GOOGLE_TAG_MANAGER_ARTIFACT  = new Artifact ("Google.TagManager",  "7.1.2.3",  "8.0", ComponentGroup.Google, csprojName: "TagManager", ignore: true);
...
void SetArtifactsPodSpecs ()
{
	...
	FIREBASE_CORE_ARTIFACT.PodSpecs = new [] {
		PodSpec.Create ("Firebase", 					  "6.31.1",   frameworkSource: FrameworkSource.Pods, frameworkName: "FirebaseCore", targetName: "FirebaseCore", subSpecs: new [] { "CoreOnly" }),
		...
		PodSpec.Create ("GoogleAPIClientForREST",         "1.4.2",    frameworkSource: FrameworkSource.Pods, subSpecs: new [] { "Vision" }, useDefaultSubspecs: true), 
		PodSpec.Create ("GoogleAppMeasurement",           "6.8.0"),
		PodSpec.Create ("GoogleDataTransport",            "7.3.0",    frameworkSource: FrameworkSource.Pods),
